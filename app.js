// 🔥 TES CLÉS NPM - ÇA MARCHE AVEC CDN COMPAT
...
// Init Firebase avec syntaxe CDN
...
if (cartBtn) cartBtn.onclick = () => $('#cartModal').classList.add('show');
...
if (closeSuccess) closeSuccess.onclick = () => $('#successModal').classList.remove('show');
